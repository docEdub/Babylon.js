                        ...
                        TraverseGraph(
                            ...
                            (entity) => {
                                ...
                                visibleItems.push({
                                    ...
                                    entity,
                                    depth,
                                    parent: section.getEntityParent && section.isChild && section.isChild(entity) ? section.getEntityParent(entity).uniqueId : section.displayName,
